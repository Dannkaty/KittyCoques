        ...
        <div class="dr-title-wrap">
            <?php if ( $recipe->rating_count && $global_toggles['enable_ratings'] ) : ?>
                <span class="dr-rating">
                    <svg class="icon"><use xlink:href="<?php echo plugin_dir_url( DELICIOUS_RECIPES_PLUGIN_FILE ) ?>assets/images/sprite.svg#rating"></use></svg>
                    <?php 
            ...
            <div class="dr-entry-meta">
                <?php if( $global_toggles['enable_author'] ) : ?>
                    <span class="dr-byline">
                        <span class="dr-meta-title">
                            <svg class="icon">
                                <use xlink:href="<?php echo plugin_dir_url( DELICIOUS_RECIPES_PLUGIN_FILE ) ?>assets/images/sprite.svg#author"></use>
                            </svg>
                ...
                ?>
                    <span class="dr-method">
                        <span class="dr-meta-title">
                            <svg class="icon">
                                <use xlink:href="<?php echo plugin_dir_url( DELICIOUS_RECIPES_PLUGIN_FILE ) ?>assets/images/sprite.svg#cooking-method"></use>
                            </svg>
                ...
                <span class="dr-cuisine">
                    <span class="dr-meta-title">
                        <svg class="icon">
                            <use xlink:href="<?php echo plugin_dir_url( DELICIOUS_RECIPES_PLUGIN_FILE ) ?>assets/images/sprite.svg#cuisine"></use>
                        </svg>
                ...
                <span class="dr-category">
                    <span class="dr-meta-title">
                        <svg class="icon">
                            <use xlink:href="<?php echo plugin_dir_url( DELICIOUS_RECIPES_PLUGIN_FILE ) ?>assets/images/sprite.svg#category"></use>
                        </svg>
                ...
                <span class="dr-category dr-recipe-keys">
                    <span class="dr-meta-title">
                        <svg class="icon">
                            <use xlink:href="<?php echo plugin_dir_url( DELICIOUS_RECIPES_PLUGIN_FILE ) ?>assets/images/sprite.svg#recipe-keys"></use>
                        </svg>
    ...
    <div class="dr-extra-meta">
        ...
        ?>
            <span class="dr-sim-metaa dr-yields">
                <span class="dr-meta-title">
                    <svg class="icon">
                        <use xlink:href="<?php echo plugin_dir_url( DELICIOUS_RECIPES_PLUGIN_FILE ) ?>assets/images/sprite.svg#yield"></use>
                    </svg>
        ...
        ?>
            <span class="dr-sim-metaa dr-calorie">
                <span class="dr-meta-title">
                    <svg class="icon">
                        <use xlink:href="<?php echo plugin_dir_url( DELICIOUS_RECIPES_PLUGIN_FILE ) ?>assets/images/sprite.svg#calories"></use>
                    </svg>
        ...
        ?>
            <span class="dr-sim-metaa dr-season">
                <span class="dr-meta-title">
                    <svg class="icon">
                        <use xlink:href="<?php echo plugin_dir_url( DELICIOUS_RECIPES_PLUGIN_FILE ) ?>assets/images/sprite.svg#season"></use>
                    </svg>
