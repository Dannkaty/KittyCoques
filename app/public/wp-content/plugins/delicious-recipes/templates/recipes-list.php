        ...
        <header class="entry-header">
            ...
            <div class="entry-meta">
                <span class="posted-on">
                    <svg class="icon">
                        <use xlink:href="<?php echo plugin_dir_url( DELICIOUS_RECIPES_PLUGIN_FILE ) ?>assets/images/sprite.svg#calendar"></use>
                    </svg>
                    <time><?php echo esc_html( delicious_recipes_get_formated_date( $recipe->date_published ) ); ?></time>
                </span>
                <span class="comment">
                    <svg class="icon">
                        <use xlink:href="<?php echo plugin_dir_url( DELICIOUS_RECIPES_PLUGIN_FILE ) ?>assets/images/sprite.svg#comment"></use>
                    </svg>
