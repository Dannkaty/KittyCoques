...
final class DeliciousRecipes {
	...
	public function load_plugin_textdomain() {
		...
		// $locale = apply_filters( 'plugin_locale', $locale, 'delicious-recipes' );

		// unload_textdomain( 'delicious-recipes' );
		// load_textdomain( 'delicious-recipes', WP_LANG_DIR . '/delicious-recipes/delicious-recipes-' . $locale . '.mo' );
