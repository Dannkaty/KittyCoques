...
class Delicious_Recipes_Activator {
	...
	public static function activate() {
		 ...
		 */
        $pages = apply_filters(
            'delicious_recipes_create_pages', array(
                'recipe-search' => array(
	...
	public static function create_roles() {
        ...
        // Recipe Editor role.
        $recipe_editor_caps = apply_filters( 'delicious_recipes_editor_caps', array(
	    	'manage_categories'      => 1,
	    	'upload_files'           => 1,
	    	'unfiltered_html'        => 1,
	    	'edit_posts'             => 1,
    ...
    public static function insert_demo_recipe() {
        ...
        $recipe_metas = apply_filters( 'delicious_recipes_demo_recipe_metas', array( 
		...
		if( ! empty( $ingredients ) ) {
            ...
            update_post_meta( $recipe_demo_id, '_dr_ingredient_count', $ingredient_count );
		}
